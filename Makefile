...
LFLAGS_RELEASE := -static `sdl2-config --static-libs` -lm -lpng -lz -lopengl32 -lglu32 -lglew32 -lluajit-5.1 -static-libstdc++ -static-libgcc
...
LFLAGS_DEVELOPMENT := `sdl2-config --libs` -lm -lpng -lz -lopengl32 -lglu32 -lglew32 -lluajit-5.1
